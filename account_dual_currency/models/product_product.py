...
class ProductProduct(models.Model):
    ...
    avg_cost_usd = fields.Monetary(string="Average Cost $", compute='_compute_value_usd_svl', compute_sudo=True,
                               currency_field='currency_id_dif')
    total_value_usd = fields.Monetary(string="Total Value $", compute='_compute_value_usd_svl', compute_sudo=True,
                                  currency_field='currency_id_dif')
    ...
    def _compute_value_usd_svl(self):
        ...
        for product in self:
            ...
            avg_cost_usd = value_usd_svl / quantity_sum if quantity_sum else 0
